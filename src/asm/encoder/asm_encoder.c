...
/*   Updated: 2017/03/19 20:42:13 by mcanal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void				encode_arg_type(t_arg_type (*arg_type)[])
{
	...
	ft_arrpush(g_cor, (void *)(t_ulong)encoded_type, -1);
}
							   ...
							   t_instruct_parsed *instruct_p)
{
		...
		if (instruct_p->op->arg_count > 1 || instruct_p->op->code == 16) // aff
